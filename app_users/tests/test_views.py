...
class TestAppUsersViews(TestCase):
    ...
    def test_registration_succes(self):
        ...
        self.assertEquals(self.User.objects.filter(
                        username=self.reg_form['username']).exists(), True)
    ...
    def test_registration_failure(self):
        ...
        response = self.client.post(reverse('registerPage'), self.reg_form)
        self.assertEquals(self.User.objects.filter(
                        username=self.reg_form['username']).exists(), False)
